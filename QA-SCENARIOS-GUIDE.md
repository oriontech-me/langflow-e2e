...
29. [UI/UX — Settings Shortcuts](#29-uiux--settings-shortcuts)
30. [Core Components — Nested / Grouping](#30-core-components--nested--grouping)
...
## 30. Core Components — Nested / Grouping

**File:** `tests/tests-automations/regression/core-components/nested-grouping-regression.spec.ts`

---

### 30.1 Group two connected non-IO components collapses them into a single Group node `[x]`
...
### 30.2 Ungrouping a Group node restores the original components and the edge `[x]`
...
**Step by step:**
1. Repeat steps 1–7 of scenario 30.1 to produce a `title-Group` node on the canvas.
