...
| `core-functionality/llm-agents/` | 40 | 32 | 4 | 1 | 3 |
...
| **TOTAL** | **533** | **420 (79%)** | **38 (7%)** | **14 (3%)** | **61 (11%)** |
...
> 497 `test()` calls carrying the `@stable` tag, distributed across 195 spec
...
| `core-functionality/llm-agents/` | 4 | 3 |
