...
- [x] Maximum agent iterations → `core-functionality/llm-agents/agent-max-iterations.spec.ts` (both halves of the causal pair `@stable`; #1264's second pass added the tool-step precondition to Test 1 — see §6.2 for the mechanism and the spec doc's Tags section for the per-provider measurement)
