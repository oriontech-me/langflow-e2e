...
| `core-components/` — Component Config | 24 | 19 | 5 | 0 | 0 |
...
| **TOTAL** | **451** | **314 (70%)** | **114 (25%)** | **8 (2%)** | **15 (3%)** |
...
> 350 `test()` calls carrying the `@stable` tag, distributed across 142 spec
...
| `core-components/` — Component Config | 5 | 0 |
