...
- [ ] Partial failure on the **canvas** — the failed node is flagged and the branches that completed show as built (declared-failing subject of the pending canvas spec, #1896: the AG-UI stream emits `RUN_ERROR` mid-run and the frontend stops there)
