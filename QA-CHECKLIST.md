...
| `core-functionality/knowledge-ingestion/` | 8 | 2 | 2 | 0 | 4 |
...
| **TOTAL** | **451** | **285 (63%)** | **138 (31%)** | **8 (2%)** | **20 (4%)** |
...
> 314 `test()` calls carrying the `@stable` tag, distributed across 125 spec
...
| `core-functionality/knowledge-ingestion/` | 2 | 4 |
